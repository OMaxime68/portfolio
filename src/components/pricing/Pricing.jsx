...
import "./pricing.css";
import Image1 from '../../assets/prices/price-1.svg';
import Image2 from '../../assets/prices/price-2.svg';
import Image3 from '../../assets/prices/price-3.svg';
  ...
  return (
    <section className="pricing container section">
      ...
      <div className="pricing__item">
          <img src={Image1} alt="pricing" className="pricing__img" />
          ...
          <a href="https://google.com" className="btn" target='_blank' rel="noreferrer">Get Started</a>
        </div>

        <div className="pricing__item best">
          <span className="badge">Recommended</span>
          <img src={Image2} alt="pricing" className="pricing__img" />
        ...
        <div className="pricing__item">
          <img src={Image3} alt="pricing" className="pricing__img" />
