      ...
      <div className="blog__container grid">
        <div className="blog__card">
          <div className="blog__thumb">
            ...
            <a href="#"><img src={Image1} alt="Blog" className='blog__img' /></a>
          </div>
        ...
        <div className="blog__card">
          <div className="blog__thumb">
            ...
            <a href="#"><img src={Image2} alt="Blog" className='blog__img' /></a>
          </div>
          <div className="blog__details">
        ...
        <div className="blog__card">
          <div className="blog__thumb">
            ...
            <a href="#"><img src={Image3} alt="Blog" className='blog__img' /></a>
          </div>
          <div className="blog__details">
